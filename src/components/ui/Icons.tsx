...
export const FeedbackIcon: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className = '' }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    width={size} 
    height={size} 
    ...
    strokeLinecap="round" 
    strokeLinejoin="round" 
    className={`feather feather-thumbs-up ${className}`}
  >
...
export const MicIcon: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className = '' }) => (
  <svg 
    ...
    strokeLinecap="round" 
    strokeLinejoin="round" 
    className={`feather feather-mic ${className}`}
  >
